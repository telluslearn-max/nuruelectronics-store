/** Shared light-mode skeleton for category listing pages — used by the route's file-based
    loading.tsx and, for non-Gaming categories, the inner Suspense fallback in page.tsx. */
