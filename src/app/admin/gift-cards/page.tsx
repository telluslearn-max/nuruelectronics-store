...
import { createGiftCardMapping, deleteGiftCardMapping } from "@/lib/gift-card-actions";
...
export default async function AdminGiftCardsPage({
  ...
  const mappings = await prisma.giftCardProductMapping.findMany({ orderBy: { createdAt: "desc" } });
